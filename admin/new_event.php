...
<div class="col-lg-12">
	<div class="card card-outline card-primary">
        ...
        <div class="row">
          ...
          <div class="col-md-6">
            <div class="form-group">
              <label for="" class="control-label">Guest Limit</label>
              <input type="number" class="form-control form-control-sm" name="guest_limit" value="<?php echo isset($guest_limit) ? $guest_limit : 0 ?>" min="0">
            </div>
          </div>
        </div>
        <div class="row">
